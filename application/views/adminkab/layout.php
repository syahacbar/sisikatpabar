...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="modal fade" id="exampleModalLong<?php echo site_url('admin/infrastruktur/layout');?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
