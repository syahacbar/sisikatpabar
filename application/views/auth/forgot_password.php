...
<html lang="en">
    <head>
        ...
        <title>Password Reset - Sisikat</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Masukkan Nomor WhatsApp Anda yang telah terdaftar di sistem SISIKAT dan kami akan mengatur ulang kata sandi lalu mengirimkannya pada anda.</div>
                                        <?php echo form_open("auth/forgot_password");?>
                                        <form>
                                            <div class="form-floating mb-3">
                                                <input name="nowhatsapp" class="form-control" id="identity" type="text" placeholder="0813xxxx" />
                                                <label for="identity">Nomoh WhatsApp</label>
                                            </div>
