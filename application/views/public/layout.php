        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Untuk gambar pertama, fokus foto ke bagian jalan atau drainase yang rusak. Lihat gambar di bawah ini sebagai contoh.
                    <div id="gambar1" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>resources/admintheme/assets/panduan/fokus-bagian-rusak-jalan.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>resources/admintheme/assets/panduan/fokus-bagian-rusak-drainase.jpg" alt="Second slide">
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="gambar2" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>resources/admintheme/assets/panduan/seluruh-badan-drainase-rusak.jpg" alt="tampak samping jalan">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>resources/admintheme/assets/panduan/seluruh-badan-jalan-rusak.jpeg" alt="tampak samping darainase">
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="<?php echo base_url(); ?>resources/admintheme/assets/panduan/pose-selfi-dengan-jalan-drainase-rusak.jpg" alt="">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
