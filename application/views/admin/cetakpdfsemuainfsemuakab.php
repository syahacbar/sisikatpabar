...
<tr>
	...
	<td>
		<img style="max-height: 100; image-resolution: 96dpi;" src="'.$dokumentasi1.'"><br>
		<img style="max-height: 100; image-resolution: 96dpi;" src="'.$dokumentasi2.'"><br>
		<img style="max-height: 100; image-resolution: 96dpi;" src="'.$dokumentasi3.'">
	</td>
</tr>';
}
$html .='</table>';
